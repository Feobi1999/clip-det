...
from .standard_roi_head_text_prompt_align import StandardRoIHeadTEXTPrompt_Align
...
from .standard_roi_head_text_prompt_R50 import StandardRoIHeadTEXTPrompt_R50
from .standard_roi_head_text_prompt_48 import StandardRoIHeadTEXTPrompt_48
__all__ = [
    'BaseRoIHead',  
      'ResLayer', 'BBoxHead',
    ...
    'StandardRoIHeadTEXTPrompt_R50','StandardRoIHeadTEXTPrompt_48','StandardRoIHeadTEXTPrompt_Align'
]
