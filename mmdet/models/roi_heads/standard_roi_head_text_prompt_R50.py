...
class StandardRoIHeadTEXTPrompt_R50(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(StandardRoIHeadTEXTPrompt_R50, self).__init__(bbox_roi_extractor=bbox_roi_extractor,
                                              bbox_head=bbox_head,
        ...
        self.clip_model, self.preprocess = clip.load('/mnt/lustre/hemengzhe/datasets/clip_pretrain/RN50.pt', device)
        ...
        save_path = dataset + '_text_embedding_RN50.pt'
