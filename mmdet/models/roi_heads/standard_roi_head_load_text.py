...
class StandardRoIHeadLoadText(BaseRoIHead, BBoxTestMixin, MaskTestMixin):
    ...
    def __init__(self,
        ...
        super(StandardRoIHeadLoadText, self).__init__(bbox_roi_extractor=bbox_roi_extractor,
                                              bbox_head=bbox_head,
        ...
        # save_path = 'class_'
        save_path = dataset + 'word_embedding.pth'
